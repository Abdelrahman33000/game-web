...
const Products = () => {
  return (
    <div className='productsPage' >
        ...
        <p style={{textAlign:"right"}}>"العاب السلامة وتنمية الفكر ارجوحة"

للجملة نرحب بجميع عملائنا في جميع مدن المملكة ونقدم لكم كل ماهو جديد اول بأول وبأسعار</p>
        <p style={{textAlign:"right"}}>تنافسية 👌 فقط اختر ماتريد من المنتج بأسهل مايمكن فقط اضغط على الصورة اسفل وتواصل معنا   
</p>
